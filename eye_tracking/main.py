...
def positionEstimator(cropped_eye):
    ...
    eye_position = "notDetected"
    try:
        if cropped_eye is not None and len(cropped_eye) > 0:
            # print(cropped_eye.shape)
...
#         #  resizing frame
#         frame = cv.imread(os.path.join("../inference/output/",filename))
#         # frame = cv.imread(os.path.join("../inference/output/", "6_4.png"))
#         print(filename)
...
def pridictEyes(frame,face_mesh):
    # CEF_COUNTER = 0
    # map_face_mesh = mp.solutions.face_mesh
    ...
    if results.multi_face_landmarks:
        ...
        if len(crop_left) > 0:
            ...
            # print("leftEye :- {} -> {}".format(filename, eye_position_left))
            # print(eye_position_left)
        return eye_position,eye_position_left
    else:
        return "notDetected","notDetected"

# if __name__ == '__main__':
#     frame = cv.imread(os.path.join("../inference/output/", "6_4.png"))
#     map_face_mesh = mp.solutions.face_mesh
#     face_mesh = map_face_mesh.FaceMesh(min_detection_confidence=0.5, min_tracking_confidence=0.5)
#     pridictEyes(frame,face_mesh)
